...
public class SLManager {
    ...
    private List<String> levelup_commands = new ArrayList<String>();
	...
	public SLManager() {
		...
		for(String k : conf.getStringList("levelup-commands")) {
			levelup_commands.add(ChatColor.translateAlternateColorCodes('&', k));
		}
	}
